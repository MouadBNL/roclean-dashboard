import{B as A,y as k,q as s,C as b,d as P,l as v,x as r,Z as N,aU as D,aV as q,aW as L,aX as O,I as F,G as T,K as I,M as X,i as j}from"./index-3c8f480c.js";import{f as $}from"./format-length-c9d165c6.js";const G=e=>{const{infoColor:o,successColor:g,warningColor:n,errorColor:i,textColor2:a,progressRailColor:u,fontSize:l,fontWeight:d}=e;return{fontSize:l,fontSizeCircle:"28px",fontWeightCircle:d,railColor:u,railHeight:"8px",iconSizeCircle:"36px",iconSizeLine:"18px",iconColor:o,iconColorInfo:o,iconColorSuccess:g,iconColorWarning:n,iconColorError:i,textColorCircle:a,textColorLineInner:"rgb(255, 255, 255)",textColorLineOuter:a,fillColor:o,fillColorInfo:o,fillColorSuccess:g,fillColorWarning:n,fillColorError:i,lineBgProcessing:"linear-gradient(90deg, rgba(255, 255, 255, .3) 0%, rgba(255, 255, 255, .5) 100%)"}},H={name:"Progress",common:A,self:G},Y=H,E=k([s("progress",{display:"inline-block"},[s("progress-icon",`
