        ...
        <NCard class="mb-12" :title="`Overview | ${trashTotal}`">
            <div class="grid grid-cols-6">
                <div class="flex items-center justify-center">
                    <div>
                        <NProgress type="circle" color="#259E73" rail-color="#259E7322" :percentage="trashPercentages.glass">
                ...
                <div class="flex items-center justify-center">
                    <div>
                        <NProgress :height="2" color="#259E73" rail-color="#259E7322" type="circle" :percentage="trashPercentages.metal">
                ...
                <div class="flex items-center justify-center">
                    <div>
                        <NProgress type="circle" color="#259E73" rail-color="#259E7322" :percentage="trashPercentages.paper">
                ...
                <div class="flex items-center justify-center">
                    <div>
                        <NProgress type="circle" color="#259E73" rail-color="#259E7322" :percentage="trashPercentages.plastic">
                ...
                <div class="flex items-center justify-center">
                    <div>
                        <NProgress type="circle" color="#259E73" rail-color="#259E7322" :percentage="trashPercentages.organic">
                ...
                <div class="flex items-center justify-center">
                    <div>
                        <NProgress type="circle" color="#259E73" rail-color="#259E7322" :percentage="trashPercentages.others">
                            <svg class="h-12" viewBox="0 0 28 28" fill="none"
